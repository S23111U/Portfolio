    ...
    <div>
      ...
      <div className="blur-background mx-10 mt-10">
        ...
        >
          ...
          >
            This report examines the transformative impact of cloud computing on
            IT and business infrastructure, emphasizing cost savings,
          ...
          >
            ...
            blockchain technology to eliminate intermediaries and ensure secure,
            transparent transactions. It explores cryptography’s role in
            blockchain, the Proof-of-Work mechanism for verification, and
          ...
          >
            The document highlights the significance and advancements of Gallium
            Nitride (GaN) based High Electron Mobility Transistors (HEMTs). It
            emphasizes their superior performance over silicon-based transistors
            due to higher electron mobility, breakdown voltage, and saturation
            current. GaN-HEMTs are crucial for high-frequency applications and
            power electronics, though high costs limit widespread adoption.
            <p>
              <i>Click title to know more</i>
            </p>
          </AccordionItem>
